# Korzystając z kodu z przykładu 4 dodaj kod, który pobierze wszystkie dane z tabeli, z której pobrane zostały nagłówki.
#  Dane następnie zapisz do pandas DataFrame ale wyeliminuj kolumnę, w której jest obraz przedstawiający daną grę oraz kolumnę 'Shop'.
#  Można to zrobić przed wstawieniem danych do frame'a.
